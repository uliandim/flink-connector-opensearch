...
import org.apache.flink.connector.opensearch.sink.Opensearch3Writer.Opensearch3BulkResponseInspector;
...
public class Opensearch3Sink<IN> implements Sink<IN> {
    ...
    private final Opensearch3BulkResponseInspectorFactory bulkResponseInspectorFactory;
    ...
    @VisibleForTesting
    Opensearch3BulkResponseInspectorFactory getBulkResponseInspectorFactory() {
        return bulkResponseInspectorFactory;
    }

    /** Factory for creating {@link Opensearch3BulkResponseInspector} instances. */
    @FunctionalInterface
    public interface Opensearch3BulkResponseInspectorFactory
            extends java.io.Serializable,
                    java.util.function.Function<
                            InitContext, Opensearch3BulkResponseInspector> {}

    /** Context for initializing the bulk response inspector. */
    @FunctionalInterface
