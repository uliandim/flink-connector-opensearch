...
import org.apache.flink.connector.opensearch.sink.Opensearch3Sink.Opensearch3BulkResponseInspectorFactory;
import org.apache.flink.connector.opensearch.sink.Opensearch3Writer.DefaultBulkResponseInspector;
...
public class Opensearch3SinkBuilder<IN> {
    ...
    private Opensearch3BulkResponseInspectorFactory bulkResponseInspectorFactory;
    ...
    /**
     * Overrides the default {@link Opensearch3BulkResponseInspectorFactory}. A custom inspector,
     * for example, can change the failure handling and capture additional metrics.
     *
     * @param bulkResponseInspectorFactory the factory
     * @return this builder
     */
    public Opensearch3SinkBuilder<IN> setBulkResponseInspectorFactory(
            Opensearch3BulkResponseInspectorFactory bulkResponseInspectorFactory) {
    ...
    protected Opensearch3BulkResponseInspectorFactory getBulkResponseInspectorFactory() {
    ...
    /**
     * Default factory for creating {@link DefaultBulkResponseInspector} instances. A static class
     * is used instead of anonymous/lambda to avoid non-serializable references to {@link
     * Opensearch3SinkBuilder}.
     */
    static class DefaultBulkResponseInspectorFactory
            implements Opensearch3BulkResponseInspectorFactory {

        private final Opensearch3FailureHandler failureHandler;

        DefaultBulkResponseInspectorFactory(Opensearch3FailureHandler failureHandler) {
            this.failureHandler = failureHandler;
        }

        @Override
        public Opensearch3Writer.Opensearch3BulkResponseInspector apply(
                Opensearch3Sink.InitContext context) {
